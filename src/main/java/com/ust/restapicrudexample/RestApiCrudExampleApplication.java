...
public class RestApiCrudExampleApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception
	{
		...
		Item item1 = itemService.createNewItem(new Item(null, "Lapiz", "Lapiz amarillo punto 2", 5.5, "Papeleria", 1));
		Item item2 = itemService.createNewItem(new Item(null, "Reglas", "Juego de geometria de 5 piezas", 15.6, "Papeleria", 1));
		...
		saleService.createNewSale(new Sale(null,5.5, itemList,customer,date,1));
		itemList.add(item2);
		saleService.createNewSale(new Sale(null,21.1, itemList,customer,date,1));
	}
